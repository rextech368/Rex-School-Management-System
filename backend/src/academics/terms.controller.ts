...
export class TermsController {
  ...
  @Post() @Roles('Admin') create(@Body() dto: CreateTermDto) { return this.service.create(dto); }
  @Put(':id') @Roles('Admin') update(@Param('id') id: string, @Body() dto: Partial<CreateTermDto>) { return this.service.update(+id, dto); }
