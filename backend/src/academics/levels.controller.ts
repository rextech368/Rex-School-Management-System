...
export class LevelsController {
  ...
  @Post() @Roles('Admin') create(@Body() dto: CreateLevelDto) { return this.service.create(dto); }
  @Put(':id') @Roles('Admin') update(@Param('id') id: string, @Body() dto: Partial<CreateLevelDto>) { return this.service.update(+id, dto); }
